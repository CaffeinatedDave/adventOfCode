...
instructions.each do |ins|
  ...
  if !soloDelivered.include?(newloc)
    soloDelivered << newloc
  end 
end

puts "Santa has delivered to #{soloDelivered.length} houses"
...
puts "Santa has delivered to #{delivered.length} houses"
