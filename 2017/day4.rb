...
phrases.each do |p|
  ...
  if anagramUsed.length == words.length
    anagramCount += 1
  end
...
puts "There are #{uniqueCount} valid phrases (unique words)"
puts "There are #{anagramCount} valid phrases (anagram words)"
