...
val intersections = getRoute(i1).intersect(getRoute(i2))

intersections.map(_.manhattanDistanceFrom00).min

intersections.map(i => stepsTo(i, i1) + stepsTo(i, i2)).min
